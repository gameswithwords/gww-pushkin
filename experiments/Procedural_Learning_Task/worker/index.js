...
const options = {
	...
	readQueue: 'Procedural_Learning_Task_quiz_dbread',
	writeQueue: 'Procedural_Learning_Task_quiz_dbwrite',
	taskQueue: 'Procedural_Learning_Task_quiz_taskworker',
};
...
worker.init()
	.then(() => {
		...
		worker.useHandler(defaultHandler, connection, 'Procedural_Learning_Task', transactionOps);
		worker.start();
	})
	.catch(err => {
