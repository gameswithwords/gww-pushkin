		...
		<div className="white">
			<Row className="display">
				<Col xs={12}>
					<div className="blurb">
						<p className="blurb">
							Want to participate in science not just as a subject but as a researcher? Professional
							researchers are increasingly{" "}
							<a href="http://en.wikipedia.org/wiki/Citizen_science">turning to amateurs</a> to
							solve critical scientific problems. Help out with one of our projects below.
						</p>
						<hr />
