...
export default function AboutPage() {
  ...
  return (
    <div style={{ marginLeft: '20px', marginRight: '20px' }}>
      <div>
        <Row>
          <Col xs={12} md={9} style={{ borderRight: 'dashed #a9a9a9', minHeight: '400px' }}>
            <div className="blurb" style={{ marginRight: '20px', fontSize: '18px' }}>
              <p className="blurb">
          ...
          <Col xs={12} md={3}>
            <div style={{ marginTop: '20px' }}>
              <h1 className="title" onClick={() => setShowPeople(true)} style={{ cursor: 'pointer' }}>
                People
              </h1>

              <h1 className="title" onClick={() => setShowFunding(true)} style={{ cursor: 'pointer' }}>
                Funding
              </h1>

              <h1 className="title" onClick={() => setShowMedia(true)} style={{ cursor: 'pointer' }}>
                Media
              </h1>

              <h1 className="title" onClick={() => setShowLinks(true)} style={{ cursor: 'pointer' }}>
                Links
              </h1>

              <h1 className="title" onClick={() => setShowContact(true)} style={{ cursor: 'pointer' }}>
                Contact
              </h1>
            </div>
          </Col>
      ...
      {/* People Modal */}
      <Modal show={showPeople} onHide={() => setShowPeople(false)} size="lg">
        <Modal.Header closeButton>
          <Modal.Title>People</Modal.Title>
        </Modal.Header>
        <Modal.Body className="blurb">
          <p>
          ...
          <p>
            ...
            <a href="http://www.bc.edu/schools/cas/psych.html">
              Boston College
            </a>, and the founder of GamesWithWords.org. He is broadly
          ...
          <p>
            ...
            Colorado-Boulder and is a collaborator on the VerbCorner Project.
          </p>
          <hr />
          <p>
            <b>Amy Geojo</b>
          ...
          <p>
            ...
            <a href="http://testmybrain.org">TestMyBrain.org</a>. She
            collaborated on the Memory Test.
          </p>
          <hr />
          <p>
          ...
          <p>
            ...
            is collaborating with Josh on the Birth Order project.
          ...
          <p>
            ...
            collaborated on Collecting Fancy Art.
          </p>
          <hr />
          <p>
            <b>Tal Makovski</b>
          ...
          <p>
            ...
            visual cognition, such as Rapid Reading and The Video Experiment.
          </p>
          <hr />
          <p>
            <a href="http://verbs.colorado.edu/~mpalmer/">
              <b>Martha Palmer</b>
            </a>
          </p>
          <p>
            Martha Palmer is a professor at the University of Colorado
            and is a collaborator on the VerbCorner Project.
          </p>
          <hr />
          <p>
          ...
          <p>
            ...
            Birth Order project. They are related, too.
          </p>
          <hr />
          <p>
            <b>Jesse Snedeker</b>
          ...
          <p>
            ...
            collaborated with Josh on Word Sense.
          </p>
        </Modal.Body>
        <Modal.Footer>
          <Button variant="secondary" onClick={() => setShowPeople(false)}>
            Close
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      {/* Funding Modal */}
      <Modal show={showFunding} onHide={() => setShowFunding(false)} size="lg">
        <Modal.Header closeButton>
          <Modal.Title>Funding</Modal.Title>
        </Modal.Header>
        <Modal.Body className="blurb">
          <p>
            GamesWithWords.org is currently funded through a start-up
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={() => setShowFunding(false)}>
            Close
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      {/* Media Modal */}
      <Modal show={showMedia} onHide={() => setShowMedia(false)} size="lg">
        <Modal.Header closeButton>
      ...
      {/* Links Modal */}
      <Modal show={showLinks} onHide={() => setShowLinks(false)} size="lg">
        <Modal.Header closeButton>
      ...
      <Modal show={showContact} onHide={() => setShowContact(false)} size="lg">
        ...
        <Modal.Body className="blurb">
          ...
          <p>
            ...
            GamesWithWords.org projects, please reach out via email.
          </p>
        </Modal.Body>
        <Modal.Footer>
